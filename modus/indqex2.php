...
<html>
<head>
    <title>Modus - Single Page Portfolio Theme | GraphBerry.com</title>
    <meta charset="utf-8">
		  ...
		  <div class="container">
		    ...
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand smoothScroll" href="#home">
		        <img src="C:\Users\user\OneDrive\سطح المكتب\A.jpg">
		      </a>
		    </div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="service">
							<figure>
								<img src="C:\Users\user\OneDrive\المستندات/s.jpg" alt="Idea image">
	...
	<footer id="footer">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<small class="copyright"> © <span id="year">2017</span> - <a 
				</div>
